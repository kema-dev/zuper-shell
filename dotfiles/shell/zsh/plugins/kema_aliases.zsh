...
if type eza >/dev/null; then
	alias ls='eza --header --group --group-directories-first --icons --links --git --binary --time-style=long-iso --color=always'
...
alias mouse_init='sudo rivalcfg --update-udev'
alias mouse_color='rivalcfg --color'
alias mouse_battery='rivalcfg --battery-level'
# git
...
# zsh
alias zsh_debug_startup='KEMA_ZSH_DEBUG_STARTUP=1 zsh -i'
...
alias file_server_to_any_remote='croc'
alias jn='journal'
alias jo='journal open'
alias mf='journal find'
alias meet='meeting'
alias mo='meeting open'
alias mf='meeting find'
alias gr='gclcr'
