...
# VS Code
export KEMA_VSCODE_TERM_PROGRAM_NAME="vscode"
...
# development
export KEMA_DEV_DIR="${HOME}/dev"
export KEMA_GIT_REPOS_DIR="${KEMA_DEV_DIR}/git"

# aliases tips
export KEMA_ALIASES_LIST_PATH="${HOME}/.cache/kema_aliases_list"
...
export KEMA_DIRSTACK_HISTORY_PATH="${HOME}/.kema_dirstack_history"
